...
describe("caesar", () => {
    ...
    it("should return an answer with spaces maintained throughout", () => {
        const expected = "bpqa qa i amkzmb umaaiom!";
        const actual = caesar("This is a secret message!", 8)
        expect(actual).to.equal(expected);
      });
      it("should return an answer with non-letters included", () => {
        const expected = "$bpqa qa i amkzmb umaaiom!";
        const actual = caesar("$This is a secret message!", 8);
        expect(actual).to.equal(expected);
      });
      it("should return an answer with the correctly shifted numbers if the 'shift' number is positive", () => {
        const expected = "wklqnixo";
        const actual = caesar("thinkful", 3);
        expect(actual).to.equal(expected);
      });
      it("should return an answer with the correctly shifted numbers if the 'shift' number is negative", () => {
        const expected = "qefkhcri";
        const actual = caesar("thinkful", -3);
        expect(actual).to.equal(expected);
      });
      it("should return an answer with the correctly shifted numbers if the 'shift' number is longer than the alphabet", () => {
        const expected = "ccc";
        const actual = caesar("zzz", 3);
        expect(actual).to.equal(expected);
      });
      it("should return an answer with the correctly shifted numbers while ignoring capital letters", () => {
        const expected = "wklqnixo";
        const actual = caesar("Thinkful", 3);
        expect(actual).to.equal(expected);
      });
      it("should return an answer with the correctly shifted numbers if 'encode' is set to 'false' (decrypt a message (input))", () => {
